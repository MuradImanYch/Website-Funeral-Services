...
<section class="header">
    <div class="wrap">
        <div class="container">
            ...
            <div><a href="/ua">Главная</a> <span>/</span> <p>Контакти</p></div>
        </div>
    </div>
</section>
...
<section id="feedback">
    <div class="container">
        <span>Ритуальні послуги</span>
        <h3><span>Зв'язок</span> з нами</h3>

        <form>
            <input type="text" name='name' placeholder="Ваше ім'я" />
            <input type="number" name='telephone' placeholder='Телефон' />
            <input type="email" name='email' placeholder='Пошта' />
            <textarea name="text" cols="30" rows="10" placeholder='Повiдомлення'></textarea>
